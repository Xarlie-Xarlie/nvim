return {
  ...
  init = function()
    require("which-key").add({
      ...
      -- JSON (Tooling)
      { "<leader>j",  group = "JSON" },
      { "<leader>jf", "<cmd>JsonFormatFile<cr>",                                          desc = "Format File" },
      { "<leader>je", "<cmd>JsonEscapeFile<cr>",                                          desc = "Escape File" },
      { "<leader>js", "<cmd>JsonFormatSelection<cr>",                                     desc = "Format Selection" },
      { "<leader>ju", "<cmd>JsonUnescapeFile<cr>",                                        desc = "Unescape File" },
    })
  end
}
